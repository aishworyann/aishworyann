...
9.  On line 50, change `/aishworyann/aishworyann/` to `/<your-username>/<your-username>/`. This will make sure that you're fetching your snake contributions svg and not mine.
10. Customize your support link or replace it with footer typing animation (line 73).
